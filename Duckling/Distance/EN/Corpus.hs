...
--             , "10 kms, 8 meters, and 6 cm" -- Oxford comma not supported
  ...
  , examples (simple M 3) -- The original, ambiguous "m" unit is preserved
             [
               "3m"
             ]
  , examples (simple Centimetre 305) -- The ambiguous "m" unit is inferred as "meteres"
             [
               "3m and 5cm"
             ]
  , examples (simple Foot 5281) -- The ambiguous "m" unit is inferred as "miles"
             [
               "1m and 1ft"
             ]
  -- Ranges:
